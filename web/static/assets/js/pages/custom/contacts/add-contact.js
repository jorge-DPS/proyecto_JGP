...
var KTContactsAdd = function() {
    ...
    var _initWizard = function() {
        ...
        _wizardObj.on('submit', function(wizard) {
            Swal.fire({
                text: "Los datos son correctos! Por favor confirma que quieres guardar un nuevo Cliente.",
                icon: "success",
                ...
                if (result.value) {
                    console.log("almacenando nuevo cliente")
                    ...
                    Swal.fire({
                        text: "Los datos del nuevo cliente no se almacenarán!.",
                        icon: "error",
                        buttonsStyling: false,
