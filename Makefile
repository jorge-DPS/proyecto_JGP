...
fixtures:
	@echo "Loading fixtures..."
	$(COMPOSE) run --rm django python manage.py loaddata localidad
...
inspectdb:
	@echo "Creating inspectdb ..."
	$(COMPOSE) run --rm django python manage.py inspectdb > output_models.py $(ARG)
...
production_up:
	@echo "Server up..."
	docker-compose -f docker-compose.yml -f compose/docker-compose.prod.yml up
